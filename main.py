...
import torch
from util.vis_pipnet import visualize, visualize_topk, visualize_custom_prototype_ids
...
def run_pipnet(args=None):
    ...
    trainloader, trainloader_pretraining, trainloader_normal, trainloader_normal_augment, projectloader,testset_single_img_loader, testloader, test_projectloader, classes = get_dataloaders(
        args, device)
    if len(classes) <= 20:
    ...
    #visualize_topk(net, projectloader, len(classes), device, 'visualised_pretrained_prototypes_topk_Test', args)
    if net.module._num_classes == 2:

        # Create a csv log for storing the test accuracy, F1-score, mean train accuracy and mean loss for each epoch satisfying the needs in the specific usecase
        if (args.dataset == 'waterbirds_4_classes_eval'):
            log.create_log('log_epoch_overview', 'epoch', 'test_top1_acc', 'test_f1', 'almost_sim_nonzeros',
                           ...
                           'mean_train_acc',
                           'mean_train_loss_during_epoch','acc_landbird_land','acc_landbird_water','acc_waterbird_land','acc_waterbird_water')
        elif(args.dataset == 'waterbirds'):
            log.create_log('log_epoch_overview', 'epoch', 'test_top1_acc', 'test_f1', 'almost_sim_nonzeros',
                           'local_size_all_classes', 'almost_nonzeros_pooled', 'num_nonzero_prototypes',
                           'mean_train_acc', 'mean_train_loss_during_epoch',
                           'acc_landbird', 'acc_waterbird')
        elif (args.dataset == 'celebA'):
            log.create_log('log_epoch_overview', 'epoch', 'test_top1_acc', 'test_f1', 'almost_sim_nonzeros',
                           'local_size_all_classes', 'almost_nonzeros_pooled', 'num_nonzero_prototypes',
                           'mean_train_acc', 'mean_train_loss_during_epoch',
                           'accuracy_female','accuracy_male','precision')
        elif (args.dataset == 'celebA_4_classes_eval'):
            log.create_log('log_epoch_overview', 'epoch', 'test_top1_acc', 'test_f1', 'almost_sim_nonzeros',
                           'local_size_all_classes', 'almost_nonzeros_pooled', 'num_nonzero_prototypes',
                           'mean_train_acc',
                           'mean_train_loss_during_epoch',
                           'accuracy_female', 'accuracy_male','precision',
                           "acc_female_glasses", "acc_female_no_glasses",
                           "acc_male_glasses", "acc_male_no_glasses")
        elif (args.dataset == 'isic'):
            log.create_log('log_epoch_overview', 'epoch', 'test_top1_acc', 'test_f1', 'almost_sim_nonzeros',
                           'local_size_all_classes', 'almost_nonzeros_pooled', 'num_nonzero_prototypes',
                           'mean_train_acc',
                           'mean_train_loss_during_epoch',
                           'accuracy_benign', 'accuracy_malignant')
        elif (args.dataset == 'isic_4G'):
            log.create_log('log_epoch_overview', 'epoch', 'test_top1_acc', 'test_f1', 'almost_sim_nonzeros',
                           'local_size_all_classes', 'almost_nonzeros_pooled', 'num_nonzero_prototypes',
                           'mean_train_acc',
                           'mean_train_loss_during_epoch',
                           'accuracy_benign', 'accuracy_malignant','accuracy_benign_np','accuracy_benign_p', 'accuracy_malignant_np', 'accuracy_malignant_p')

        else:
            log.create_log('log_epoch_overview', 'epoch', 'test_top1_acc', 'test_f1', 'almost_sim_nonzeros',
                       'local_size_all_classes', 'almost_nonzeros_pooled', 'num_nonzero_prototypes', 'mean_train_acc',
                       'mean_train_loss_during_epoch')
        print(
        ...
        log.create_log('log_epoch_overview', 'epoch', 'test_top1_acc', 'test_top5_acc', 'almost_sim_nonzeros',
                       'local_size_all_classes', 'almosxt_nonzeros_pooled', 'num_nonzero_prototypes', 'mean_train_acc',
                       'mean_train_loss_during_epoch')
    ...
    for epoch in range(1, args.epochs_pretrain + 1):
        ...
        train_info = train_pipnet(net, trainloader_pretraining, optimizer_net, optimizer_classifier, scheduler_net,
                                  None, criterion, epoch, args.epochs_pretrain, device, pretrain=True, finetune=False)
        ...
        if (args.dataset == 'waterbirds_4_classes_eval'):
            log.log_values('log_epoch_overview', epoch, "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.",
                               train_info['loss'], 'n.a', 'n.a', 'n.a', 'n.a')
        elif (args.dataset == 'waterbirds'):
            log.log_values('log_epoch_overview', epoch, "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.",
                           train_info['loss'], 'n.a', 'n.a')
        elif (args.dataset == 'celebA'):
            log.log_values('log_epoch_overview', epoch, "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.",
                           train_info['loss'], 'n.a', 'n.a', 'n.a', )
        elif (args.dataset == 'celebA_4_classes_eval'):
            log.log_values('log_epoch_overview', epoch, "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.",
                           train_info['loss'], 'n.a', 'n.a', 'n.a', 'n.a', 'n.a', 'n.a', 'n.a')
        elif (args.dataset == 'isic'):
            log.log_values('log_epoch_overview', epoch, "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.",
                       train_info['loss'], 'n.a', 'n.a')
        elif (args.dataset == 'isic_4G'):
            log.log_values('log_epoch_overview', epoch, "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.", "n.a.",
                       train_info['loss'], 'n.a', 'n.a', 'n.a', 'n.a', 'n.a', 'n.a')
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # Evaluate model
        eval_info = eval_pipnet(net, testloader, testset_single_img_loader, epoch, device, args, log)
        if (args.dataset == 'waterbirds_4_classes_eval'):
            log.log_values('log_epoch_overview', epoch, eval_info['top1_accuracy'], eval_info['top5_accuracy'],
                           ...
                           eval_info["acc_landbird_on_land"], eval_info["acc_landbird_on_water"],
                           eval_info["acc_waterbird_on_land"], eval_info["acc_waterbird_on_water"])
        elif (args.dataset == 'waterbirds'):
            log.log_values('log_epoch_overview', epoch, eval_info['top1_accuracy'], eval_info['top5_accuracy'],
                           eval_info['almost_sim_nonzeros'], eval_info['local_size_all_classes'],
                           eval_info['almost_nonzeros'], eval_info['num non-zero prototypes'], "n.a.", "n.a.",
                           eval_info["acc_landbird"], eval_info["acc_waterbird"])
        elif(args.dataset == 'celebA'):
            log.log_values('log_epoch_overview', epoch, eval_info['top1_accuracy'], eval_info['top5_accuracy'],
                           eval_info['almost_sim_nonzeros'], eval_info['local_size_all_classes'],
                           eval_info['almost_nonzeros'], eval_info['num non-zero prototypes'], "n.a.", "n.a.",
                           eval_info["acc_female_celeb"],eval_info["acc_male_celeb"],eval_info["precision"])
        elif (args.dataset == 'celebA_4_classes_eval'):
            log.log_values('log_epoch_overview', epoch, eval_info['top1_accuracy'], eval_info['top5_accuracy'],
                           eval_info['almost_sim_nonzeros'], eval_info['local_size_all_classes'],
                           eval_info['almost_nonzeros'], eval_info['num non-zero prototypes'], "n.a.", "n.a.",
                           eval_info["acc_female_celeb"],  eval_info["acc_male_celeb"],eval_info["precision"],
                           eval_info["acc_female_glasses"], eval_info["acc_female_no_glasses"],
                           eval_info["acc_male_glasses"], eval_info["acc_male_no_glasses"])
        elif (args.dataset == 'isic'):
            log.log_values('log_epoch_overview', epoch, eval_info['top1_accuracy'], eval_info['top5_accuracy'],
                           eval_info['almost_sim_nonzeros'], eval_info['local_size_all_classes'],
                           eval_info['almost_nonzeros'], eval_info['num non-zero prototypes'], "n.a.", "n.a.",
                           eval_info["acc_benign"], eval_info["acc_malignant"])
        elif (args.dataset == 'isic_4G'):
            log.log_values('log_epoch_overview', epoch, eval_info['top1_accuracy'], eval_info['top5_accuracy'],
                           eval_info['almost_sim_nonzeros'], eval_info['local_size_all_classes'],
                           eval_info['almost_nonzeros'], eval_info['num non-zero prototypes'], "n.a.", "n.a.",
                           eval_info["acc_benign"], eval_info["acc_malignant"],
                           eval_info['accuracy_benign_np'],eval_info['accuracy_benign_p'], eval_info['accuracy_malignant_np'],eval_info[ 'accuracy_malignant_p'])
    ...
    if (args.epochs == 0):
        eval_info = eval_pipnet(net, testloader, testset_single_img_loader,"TEST_ANTON", device, args, log)
        if(args.dataset == 'waterbirds_4_classes_eval'):
            log.log_values('log_epoch_overview', epoch, eval_info['top1_accuracy'], eval_info['top5_accuracy'],
                       eval_info['almost_sim_nonzeros'], eval_info['local_size_all_classes'],
                       eval_info['almost_nonzeros'], eval_info['num non-zero prototypes'], "n.a.", "n.a.",
    ...
    for percent in [95.]:
        ...
        for ood_dataset in ood_datasets:
            if ood_dataset != args.dataset:
                ...
                _, _, _, _, _, _, ood_testloader, _, _ = get_dataloaders(ood_args, device)
