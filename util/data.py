...
def get_data(args: argparse.Namespace): 
    ...
    if args.dataset == 'waterbirds':
        return get_pets(True, './data/WATERBIRD_ALL/waterbird/train', './data/WATERBIRD_ALL/waterbird/train', './data/WATERBIRD_ALL/waterbird/test',
                        args.image_size, args.seed, args.validation_size)
    if args.dataset == 'waterbirds_4_classes_eval':
        return get_pets(True, './data/WATERBIRD_ALL/waterbird/train', './data/WATERBIRD_ALL/waterbird/train', './data/WATERBIRD_ALL/waterbirds_4g/test',
                        args.image_size, args.seed, args.validation_size)
    if args.dataset == 'celebA':
        return get_pets(True, './data/CELEB_A/celebA/train', './data/CELEB_A/celebA/train', './data/CELEB_A/celebA/test',
                        args.image_size, args.seed, args.validation_size)
    if args.dataset == 'celebA_4_classes_eval':
        return get_pets(True, './data/CELEB_A/celebA_nach_glasses/train', './data/CELEB_A/celebA_nach_glasses/train', './data/CELEB_A/celebA_nach_glasses/test',
                        args.image_size, args.seed, args.validation_size)
    if args.dataset == 'isic':
        return get_pets(True, './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/ISIC/test',
                        args.image_size, args.seed, args.validation_size)
    if args.dataset == 'isic_4G':
        return get_pets(True, './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/ISIC_4G/test',
                        args.image_size, args.seed, args.validation_size)
    if args.dataset == 'isic_mal_patches':
        return get_pets(True, './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/ISIC/test',
                        args.image_size, args.seed, args.validation_size)
    if args.dataset == 'isicTEST':
        return get_pets(True, './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/ISIC/test',
                        args.image_size, args.seed, args.validation_size)
    if args.dataset == 'B_insert_p':
        return get_pets(True, './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/B_insert_p/test',
                        args.image_size, args.seed, args.validation_size)
    if args.dataset == 'mal_insert':
        return get_pets(True, './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/malignant_w_inserted_patches/test',
                        args.image_size, args.seed, args.validation_size)
    if args.dataset == 'only_B_w_P':
        return get_pets(True, './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/ISIC/train', './data/ISIC_ALL/only_B_with_P/test',
                        args.image_size, args.seed, args.validation_size)
...
def get_dataloaders(args: argparse.Namespace, device):
    ...
    testset_single_img_loader = torch.utils.data.DataLoader(testset,
                                                batch_size=1,
                                                shuffle=False,
                                                pin_memory=cuda,
                                                num_workers=num_workers,
    ...
    return trainloader, trainloader_pretraining, trainloader_normal, trainloader_normal_augment, projectloader, testset_single_img_loader, testloader, test_projectloader, classes
...
def create_datasets(transform1, transform2, transform_no_augment, num_channels:int, train_dir:str, project_dir: str, test_dir:str, seed:int, validation_size:float, train_dir_pretrain = None, test_dir_projection = None, transform1p=None):
    ...
    if test_dir is None:
        ...
        train_indices, dices = train_test_split(train_indices,test_size=validation_size,stratify=subset_targets, random_state=seed)
        ...
        #testset.classes = ["waterbird","waterbird","waterbird","waterbird"]
